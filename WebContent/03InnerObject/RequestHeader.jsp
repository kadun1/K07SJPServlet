...
<%
/*
getHeaderNames() : 클라이언트의 요청헤드의 name속성을 모두
...
<%
	String webBrouser = request.getHeader("user-agent");
	if(webBrouser.toUpperCase().contains("MSIE")){
		out.println("인터넷익스플로러");
	}
	else if(webBrouser.toUpperCase().contains("FIREFOX")){
		out.println("파이어폭스");
	}
	else if(webBrouser.toUpperCase().contains("CHROME")){
		out.println("크롬");
	}
	else{
		out.println("기타브라우져");
