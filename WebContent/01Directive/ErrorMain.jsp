...
<%-- 
	errorPage 지시어
		: 해당 페이지에서 에러(예외)가 발생되었을때 예외처리르
		설정한 페이지에서 하겠다는 선언. 500에러와와 같은 페이지를
...
//웹브라우저에 출력된다. 즉 JS의 document.writh()와 같은 역할을 한다.
