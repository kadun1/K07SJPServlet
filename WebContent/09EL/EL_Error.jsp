...
<body>
	<fieldset>
		...
		<!-- 
			...
			또한 문자열끼리으 연결도 EL에서는 허용되지 않는다.
		 -->
		<h2>+를 숫자가 아닌 문자열 연결에 사용시(에러)</h2>
		<ul>
			<li>\${"10"+10 } : ${"100"+10 }[정상]</li>
			<li>\${"백"+10} } : \${"백"+10} }[에러]</li>
		...
		<!-- 
			EL에서 속성에 저근시 -이 포함된 경우에는 .으로 표현할수없고
			반드시 [ 를 통해 표현해야 한다.
		 -->
		...
		<%
			/*
			String형 배열을 선언한 후 각 요소들을 Lis컬렉션에 삽입
			*/
